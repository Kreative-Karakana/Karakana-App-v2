...
class _TrainerDashboardScreenState extends State<TrainerDashboardScreen>
  ...
  Future<void> _loadAll() async {
    ...
    try {
      ...
      final totalEbookReaders = ebooks.fold<int>(
        0,
        (sum, e) => sum + ((e as Map)['buyers_count'] as int? ?? 0),
      );
      final totalEbookRevenue = ebooks.fold<double>(
        0.0,
        (sum, e) =>
            sum +
            (double.tryParse(((e as Map)['total_revenue'] ?? '0').toString()) ??
                0.0),
      );
  ...
  Future<void> _deleteCourse(Map course) async {
    ...
    try {
      ...
      showTopPopup(
        context,
        'Imeshindikana kutuma ombi la kufuta kozi. Jaribu tena.',
      );
    }
  }
      ...
      body: NestedScrollView(
        ...
        body: _isLoading
            ...
            : TabBarView(
                ...
                children: [
                  _buildOverviewTab(surfaceColor, textPrimary, textSecondary),
                  _buildCoursesTab(
                    bgColor,
                    surfaceColor,
                    textPrimary,
        ...
        child: Padding(
          ...
          child: Stack(
            ...
            children: [
              ...
              Positioned(top: -18, child: _buildWalletFab()),
            ],
          ),
        ),
      ),
  ...
  Widget _buildCarouselCourseCard(
    Map course,
    Color surfaceColor,
    Color textPrimary,
    Color textSecondary,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 10),
                      _buildMiniStat(
                        '${_stats['published_courses'] ?? 0}',
                        'Kozi Hai',
                        const Color(0xFFE87722),
                      ),
                      const SizedBox(width: 10),
                      _buildMiniStat(
                        '${_stats['draft_courses'] ?? 0}',
                        'Rasimu',
                        const Color(0xFF7B3A10),
                      ),
                    ],
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: _buildHeroGlow(
                    140,
                    const Color(0xFFFFD1A1).withValues(alpha: 0.05),
                  ),
                ),
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Icon(icon, size: veryCompact ? 18 : 20, color: Colors.white),
        ),
      ),
    );
  }
  ...
  Widget _buildHeroSummaryRail({required bool compact}) {
    final avgRating = (_stats['avg_rating'] as double? ?? 0.0).toStringAsFixed(
      1,
    );
