        ...
        child: SingleChildScrollView(
          ...
          child:
            ...
            _section(
              ...
              isSw
                  ? 'Malipo yote kwa huduma zetu hushughulikiwa kwa usalama kupitia washirika wetu wa malipo. Sera za marejesho zinatofautiana kulingana na huduma na zitafahamishwa wazi wakati wa ununuzi. Tunahifadhi haki ya kubadilisha bei zetu wakati wowote kwa kutoa taarifa inayofaa.\n\nUsajili unaojirudia kiotomatiki (auto-renewable) kwenye iOS unashughulikiwa na kuchajiwa na Apple kupitia Akaunti yako ya Apple, kwa bei na muda wa usajili ulioonyeshwa na Apple kabla ya kununua. Usajili utajirudia kiotomatiki isipokuwa ukiughairi angalau saa 24 kabla ya kipindi cha sasa kuisha, kupitia Mipangilio ya Akaunti yako ya Apple. Ukighairi au usajili ukiisha, ufikiaji wa maudhui yanayohitaji usajili utakoma mwishoni mwa kipindi kilicholipiwa. Ununuzi wa mara moja (mfano vitabu vya kidijitali au kozi binafsi) sio usajili na hauhitaji kughairiwa.'
                  : 'All payments for our services are processed securely through our payment partners. Refund policies vary by service and will be clearly communicated at the time of purchase. We reserve the right to modify our pricing at any time with appropriate notice.\n\nAuto-renewable subscriptions on iOS are billed and managed by Apple through your Apple ID account, at the subscription length and price shown by Apple before purchase. Your subscription renews automatically unless you cancel at least 24 hours before the end of the current period, via your Apple ID Account Settings. If you cancel or your subscription lapses, access to subscription-only content ends at the close of the period you already paid for. One-time purchases (such as individual eBooks or courses) are not subscriptions and do not require cancellation.',
            ),
            _section(
            ...
            _section(
              ...
              isSw
                  ? 'Tunaweza kusitisha au kufungia akaunti yako na upatikanaji wa huduma zetu wakati wowote, iwe na sababu au bila, na iwe na taarifa au bila. Ukifuta akaunti yako, wasifu wako hai na ufikiaji wako vitafutwa mara moja. Baadhi ya rekodi—kama vile historia ya malipo, ununuzi, na haki za ufikiaji, au taarifa zinazohitajika kwa sababu za kihasibu, kuzuia udanganyifu/usalama, au wajibu wa kisheria—zinaweza kuendelea kuhifadhiwa hata baada ya akaunti kufutwa. Rekodi hizo zilizohifadhiwa hazitumiki tena kuendesha akaunti yako hai.'
                  : 'We may terminate or suspend your account and access to our services at any time, with or without cause, and with or without notice. When you delete your account, your active profile and access are removed immediately. Certain records — such as payment, purchase, and entitlement history, or information needed for accounting, fraud/security, or legal obligations — may continue to be retained after your account is deleted. Retained records are not a continuation of your active account.',
            ),
            _section(
